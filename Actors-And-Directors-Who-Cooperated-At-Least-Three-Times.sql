...
-- Schema for Actors And Directors Who Cooperated At Least Three Times:
...
-- Insert sample data into ActorDirector table
...
-- Solution to Actors And Directors Who Cooperated At Least Three Times
SELECT 
    actor_id, director_id
FROM
    ActorDirector
